...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    let parsedConfig: any = { chartY1Data: 'hashrate', chartY2Data: 'temperature' };
  ...
  private createChartDatasets(
    formControlName: 'chartY1Data' | 'chartY2Data',
    baseColor: string,
    mixColor: string,
    fill: boolean,
    yAxisID: 'y' | 'y2'
  ...
  private rebuildChartDatasets() {
    ...
    const datasets = [
      ...this.createChartDatasets('chartY1Data', primaryColor, textColor, true, 'y'),
      ...this.createChartDatasets('chartY2Data', textColorSecondary, 'black', false, 'y2')
    ];
  ...
  private loadPreviousData(clear: boolean = true) {
    ...
    const y1Unit = this.form.get('chartY1Data')?.value;
    const y2Unit = this.form.get('chartY2Data')?.value;
