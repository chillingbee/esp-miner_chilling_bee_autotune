...
static Settings settings[NVS_CONFIG_COUNT] =
    {[NVS_CONFIG_WIFI_SSID] = {.nvs_key_name = "wifissid",
                               .type = TYPE_STR,
                               .default_value = {.str = (char *) CONFIG_ESP_WIFI_SSID},
                               .rest_name = "ssid",
                               .min = 1,
                               .max = 32},
     [NVS_CONFIG_WIFI_PASS] = {.nvs_key_name = "wifipass",
                               .type = TYPE_STR,
                               .default_value = {.str = (char *) CONFIG_ESP_WIFI_PASSWORD},
                               .rest_name = "wifiPass",
                               .min = 0,
                               .max = 63},
     [NVS_CONFIG_HOSTNAME] = {.nvs_key_name = "hostname",
                              .type = TYPE_STR,
                              .default_value = {.str = (char *) CONFIG_LWIP_LOCAL_HOSTNAME},
                              .rest_name = "hostname",
                              .min = 1,
                              .max = 32},

     [NVS_CONFIG_POOL] = {.nvs_key_name = "pool",
                          .type = TYPE_STR,
                          .default_value = {.str = ""},
                          .rest_name = "pools",
                          .min = 0,
                          .max = NVS_STR_LIMIT,
                          .array_size = MAX_POOLS},
     [NVS_CONFIG_PRIMARY_POOL_INDEX] = {.nvs_key_name = "prim_idx",
                                        .type = TYPE_U16,
                                        .default_value = {.u16 = 0},
                                        .rest_name = "primaryPoolIndex",
                                        .min = 0,
                                        .max = MAX_POOLS - 1},
     [NVS_CONFIG_SECONDARY_POOL_INDEX] = {.nvs_key_name = "sec_idx",
                                          .type = TYPE_U16,
                                          .default_value = {.u16 = 1},
                                          .rest_name = "secondaryPoolIndex",
                                          .min = 0,
                                          .max = MAX_POOLS - 1},
     [NVS_CONFIG_USE_FALLBACK_STRATUM] =
         {.nvs_key_name = "usefbstartum", .type = TYPE_BOOL, .rest_name = "useFallbackStratum", .min = 0, .max = 1},

     [NVS_CONFIG_ASIC_FREQUENCY] = {.nvs_key_name = "asicfrequency_f",
                                    .type = TYPE_FLOAT,
                                    .default_value = {.f = CONFIG_ASIC_FREQUENCY},
                                    .rest_name = "frequency",
                                    .min = 1,
                                    .max = UINT16_MAX},
     [NVS_CONFIG_ASIC_VOLTAGE] = {.nvs_key_name = "asicvoltage",
                                  .type = TYPE_U16,
                                  .default_value = {.u16 = CONFIG_ASIC_VOLTAGE},
                                  .rest_name = "coreVoltage",
                                  .min = 1,
                                  .max = UINT16_MAX},
     [NVS_CONFIG_OVERCLOCK_ENABLED] =
         {.nvs_key_name = "oc_enabled", .type = TYPE_BOOL, .rest_name = "overclockEnabled", .min = 0, .max = 1},

     [NVS_CONFIG_DISPLAY] = {.nvs_key_name = "display",
                             .type = TYPE_STR,
                             .default_value = {.str = DEFAULT_DISPLAY},
                             .rest_name = "display",
                             .min = 0,
                             .max = NVS_STR_LIMIT},
     [NVS_CONFIG_ROTATION] = {.nvs_key_name = "rotation", .type = TYPE_U16, .rest_name = "rotation", .min = 0, .max = 270},
     [NVS_CONFIG_INVERT_SCREEN] =
         {.nvs_key_name = "invertscreen", .type = TYPE_BOOL, .rest_name = "invertscreen", .min = 0, .max = 1},
     [NVS_CONFIG_DISPLAY_OFFSET] = {.nvs_key_name = "displayOffset",
                                    .type = TYPE_U16,
                                    .default_value = {.u16 = LCD_SH1107_PARAM_DEFAULT_DISP_OFFSET},
                                    .rest_name = "displayOffset",
                                    .min = 0,
                                    .max = UINT8_MAX},
     [NVS_CONFIG_DISPLAY_TIMEOUT] = {.nvs_key_name = "displayTimeout",
                                     .type = TYPE_I32,
                                     .default_value = {.i32 = -1},
                                     .rest_name = "displayTimeout",
                                     .min = -1,
                                     .max = UINT16_MAX},

     [NVS_CONFIG_AUTO_FAN_SPEED] = {.nvs_key_name = "autofanspeed",
                                    .type = TYPE_BOOL,
                                    .default_value = {.b = true},
                                    .rest_name = "autofanspeed",
                                    .min = 0,
                                    .max = 1},
     [NVS_CONFIG_MANUAL_FAN_SPEED] = {.nvs_key_name = "manualfanspeed",
                                      .type = TYPE_U16,
                                      .default_value = {.u16 = 100},
                                      .rest_name = "manualFanSpeed",
                                      .min = 0,
                                      .max = 100},
     [NVS_CONFIG_MIN_FAN_SPEED] = {.nvs_key_name = "minfanspeed",
                                   .type = TYPE_U16,
                                   .default_value = {.u16 = 25},
                                   .rest_name = "minFanSpeed",
                                   .min = 0,
                                   .max = 99},
     [NVS_CONFIG_TEMP_TARGET] = {.nvs_key_name = "temptarget",
                                 .type = TYPE_U16,
                                 .default_value = {.u16 = 60},
                                 .rest_name = "temptarget",
                                 .min = 35,
                                 .max = 66},
     [NVS_CONFIG_OVERHEAT_MODE] =
         {.nvs_key_name = "overheat_mode", .type = TYPE_BOOL, .rest_name = "overheat_mode", .min = 0, .max = 0},

     [NVS_CONFIG_USE_CUSTOM_WWW] = {.nvs_key_name = "use_custom_www",
                                    .type = TYPE_BOOL,
                                    .default_value = {.b = false},
                                    .rest_name = "useCustomWWW",
                                    .min = 0,
                                    .max = 1},
     ...
     [NVS_CONFIG_KEY_FAN_LIMIT] =
         {
             .nvs_key_name = "fan_limit",
             .type = TYPE_U16,
             .default_value = {.u16 = 75},
         },
     [NVS_CONFIG_KEY_MAX_VOLTAGE_ASIC] =
         {
             .nvs_key_name = "max_volt_asic",
             .type = TYPE_U16,
             .default_value = {.u16 = 1400},
         },
     [NVS_CONFIG_KEY_MAX_FREQUENCY_ASIC] =
         {
             .nvs_key_name = "max_freq_asic",
             .type = TYPE_U16,
             .default_value = {.u16 = 1000},
         },
     [NVS_CONFIG_KEY_MAX_TEMP_ASIC] =
         {
             .nvs_key_name = "max_temp_asic",
             .type = TYPE_U16,
             .default_value = {.u16 = 61},
         },
     ...
     [NVS_CONFIG_KEY_OVERSHOT_POWER_LIMIT] =
         {
             .nvs_key_name = "osh_pow_limit",
             .type = TYPE_FLOAT,
             .default_value = {.f = 0.2f},
         },
     [NVS_CONFIG_KEY_OVERSHOT_FAN_LIMIT] =
         {
             .nvs_key_name = "osh_fan_limit",
             .type = TYPE_U16,
             .default_value = {.u16 = 10},
         },
...
static void get_nvs_key_name(const Settings * setting, const int index, char dest[static NVS_KEY_NAME_MAX_SIZE])
{
    if (setting->array_size > 0) {
        int width = 1;
        for (int t = setting->array_size - 1; t >= 10 && width < 5; t /= 10)
            width++;
                    ...
                    if (ret == ESP_OK) {
                        ...
                        if (root) {
                            ...
                            if (primary && primary->valuestring) {
                                ESP_LOGI(TAG, "Migrating NVS config themecolors to %s (%s)", setting->nvs_key_name,
                                         primary->valuestring);
...
esp_err_t nvs_config_init(void)
{
    ...
    for (NvsConfigKey key = 0; key < NVS_CONFIG_COUNT; key++) {
        ...
        if (!setting->value) {
            ESP_LOGE(TAG, "Failed to allocate memory for setting %d", key);
...
{
    Settings * setting = nvs_config_get_settings(key);
    if (!setting || setting->type != TYPE_STR || (setting->value[0].str && strcmp(setting->value[0].str, value) == 0))
        return;
...
{
    Settings * setting = nvs_config_get_settings(key);
    if (!setting || setting->type != TYPE_U16 || setting->value[0].u16 == value)
        return;
...
{
    Settings * setting = nvs_config_get_settings(key);
    if (!setting || setting->type != TYPE_I32 || setting->value[0].i32 == value)
        return;
...
{
    Settings * setting = nvs_config_get_settings(key);
    if (!setting || setting->type != TYPE_U64 || setting->value[0].u64 == value)
        return;
...
{
    Settings * setting = nvs_config_get_settings(key);
    if (!setting || setting->type != TYPE_FLOAT || fabsf(setting->value[0].f - value) < 0.001f)
        return;
...
{
    Settings * setting = nvs_config_get_settings(key);
    if (!setting || setting->type != TYPE_BOOL || setting->value[0].b == value)
        return;
